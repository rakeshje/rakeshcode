...
@Component({
  selector: 'app-view-patient-management-hospital',
  templateUrl: './view-patient-management-hospital.component.html',
  styleUrls: ['./view-patient-management-hospital.component.css']
})
export class ViewPatientManagementHospitalComponent implements OnInit {
  patientData: any = [];
  ...
  getPatient() {
    ...
    this.mainService.postApi(ApiUrls.viewPatientListHospital, data, 1).subscribe((res: any) => {
  ...
  // ----------------------------- view patient by id ----------------------------------- //
  viewPatient(patientId, hospitalId, viewScreen) {
    ...
    console.log(data)
    this.mainService.showSpinner()
    this.mainService.postApi(ApiUrls.viewPatientHospital, data, 1).subscribe((res: any) => {
