...
export class MainserviceService {
  ...
  // baseURL = 'http://ec2-35-176-66-190.eu-west-2.compute.amazonaws.com:1529/api/v1/';
     baseURL = 'http://182.72.203.245:1800/api/v1/';

  constructor(private router: Router, public httpClient: HttpClient , private toastrService : ToastrService,
