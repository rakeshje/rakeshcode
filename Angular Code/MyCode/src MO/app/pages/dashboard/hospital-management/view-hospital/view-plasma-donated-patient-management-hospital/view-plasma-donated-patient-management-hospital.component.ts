...
@Component({
  selector: 'app-view-plasma-donated-patient-management-hospital',
  templateUrl: './view-plasma-donated-patient-management-hospital.component.html',
  styleUrls: ['./view-plasma-donated-patient-management-hospital.component.css']
})
export class ViewPlasmaDonatedPatientManagementHospitalComponent implements OnInit {
  ...
  getPlasmaDonatedPatient() {
    ...
    this.mainService.postApi(ApiUrls.viewPlasmaDonatedPatientListHospital, data, 1).subscribe((res: any) => {
  ...
  viewPlasmaDonatedPatient(patientId, hospitalId, viewScreen) {
    ...
    console.log(data)
    this.mainService.showSpinner()
    this.mainService.postApi(ApiUrls.viewPlasmaDonatedPatientHospital, data, 1).subscribe((res: any) => {
